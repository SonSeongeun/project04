...
public class BoardDAO {
	...
	private final String BOARD_INSERT = "insert into BOARD (title, writer, content, age) values (?,?,?,?)";
	private final String BOARD_UPDATE = "update BOARD set title=?, writer=?, content=?, age=? where seq=?";
